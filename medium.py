...
game_font = font.nametofont("TkFixedFont")                                #arc, chord, or pieslice
...
lives_remaining = 3
lives_text = c.create_text(canvas_width-10, 30, anchor="ne", font=game_font, fill="white", text="Lives: "+ str(lives_remaining))
